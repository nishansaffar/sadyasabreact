...
export const extendedDeck = [
  // Dish Cards (6–8 each)
  '🍃 Banana Leaf','🍃 Banana Leaf','🍃 Banana Leaf','🍃 Banana Leaf','🍃 Banana Leaf','🍃 Banana Leaf','🍃 Banana Leaf','🍃 Banana Leaf',
  '🍚 Rice','🍚 Rice','🍚 Rice','🍚 Rice','🍚 Rice','🍚 Rice',
  '🥣 Sambar','🥣 Sambar','🥣 Sambar','🥣 Sambar','🥣 Sambar',
  '🥦 Aviyal','🥦 Aviyal','🥦 Aviyal','🥦 Aviyal','🥦 Aviyal',
  '🍌 Kaalan','🍌 Kaalan','🍌 Kaalan','🍌 Kaalan','🍌 Kaalan',
  '🥬 Thoran','🥬 Thoran','🥬 Thoran','🥬 Thoran','🥬 Thoran',
  '🥒 Pachadi','🥒 Pachadi','🥒 Pachadi','🥒 Pachadi','🥒 Pachadi',
  '🍘 Pappadam','🍘 Pappadam','🍘 Pappadam','🍘 Pappadam','🍘 Pappadam',
  '🍌 Banana Chips','🍌 Banana Chips','🍌 Banana Chips','🍌 Banana Chips','🍌 Banana Chips',
  '🌶 Pickle','🌶 Pickle','🌶 Pickle','🌶 Pickle','🌶 Pickle',
  '🍮 Payasam','🍮 Payasam','🍮 Payasam',

  // Power Cards
  '🚀 Thiruvonam Rush','🚀 Thiruvonam Rush','🚀 Thiruvonam Rush','🚀 Thiruvonam Rush',
  '🍽 Double Pappadam','🍽 Double Pappadam','🍽 Double Pappadam','🍽 Double Pappadam',
  '🧓 Muthassi’s Blessing','🧓 Muthassi’s Blessing','🧓 Muthassi’s Blessing','🧓 Muthassi’s Blessing',

  // Sabotage Cards
  '🎧 Sadya Disaster BGM','🎧 Sadya Disaster BGM','🎧 Sadya Disaster BGM','🎧 Sadya Disaster BGM',
  '🥄 Sambar Spilled','🥄 Sambar Spilled','🥄 Sambar Spilled','🥄 Sambar Spilled',
  '🍯 Payasam Overflow','🍯 Payasam Overflow','🍯 Payasam Overflow','🍯 Payasam Overflow',
  '🧻 Pappadam Crushed','🧻 Pappadam Crushed','🧻 Pappadam Crushed','🧻 Pappadam Crushed'
];
